...
- **full_online_no_write**: NLL/event=2.743822, ACC=0.2562, macro-F1=0.2535, local-time MAE=5.1932
- **full_online**: NLL/event=2.743680, ACC=0.2562, macro-F1=0.2535, local-time MAE=5.1932
...
- **online_vs_frozen_gain**: mean ΔNLL=+0.000142, improved events=10.1%, 95% CI=[0.00010321537534204813, 0.00018305799458175897]
- **realized_write_gain**: mean ΔNLL=+0.000142, improved events=10.1%, 95% CI=[0.00010321422909887937, 0.00018305776533312522]
...
- **write**: Spearman=0.03152255123466772, ROC-AUC=0.47595651560073415, PR-AUC=0.9440760949975854, regret/event=0.550624.
  Write ranking: pair-acc=0.5604, NDCG@4=0.5066, Top-4=2.318015, random-Top-4=2.372830, regret/sequence=2.173505.
- **split**: unavailable (No Sleep-evaluated Split labels in checkpoint replay.).
- Research thresholds overall: **FAIL**; details: `{'mean_writes_le_2': True, 'write_budget_utilization_le_0_5': True, 'memory_gain_target': True, 'adapt_spearman_ge_0_35': True, 'retrieve_spearman_gt_0_10': True, 'write_roc_auc_gt_0_60': True, 'write_ranking_spearman_gt_0_10': False, 'write_pairwise_accuracy_gt_0_55': True, 'write_top4_uplift_positive': False, 'write_ranking_better_than_baseline': False, 'write_positive_negative_ge_20': True, 'online_harmful_fraction_lt_0_45': True, 'full_online_gain_gt_0': True, 'frozen_acc_macro_f1_not_below_v4': None, 'frozen_controller_output_unchanged': True, 'retrieve_policy_unchanged': True, 'adapt_policy_unchanged': True}`.
