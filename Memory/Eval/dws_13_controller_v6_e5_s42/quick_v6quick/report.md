...
- **full_online**: NLL/event=2.743465, ACC=0.2553, macro-F1=0.2527, local-time MAE=5.1929
...
- **online_vs_frozen_gain**: mean ΔNLL=+0.000357, improved events=13.7%, 95% CI=[0.00027743929262774494, 0.0004440678883558856]
...
- **write**: Spearman=-0.10662218776280419, ROC-AUC=0.26476608187134504, PR-AUC=0.8252599586272449, regret/event=0.570386.
